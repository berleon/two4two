...
class Blender():
    ...
    # python names should be lower case and probably _start_new as the method is private
    def StartNew(self):
    ...
    def __init__(self,
                 ...
                 n_processes,
                 chunk_size,
                 # or add blender_path directly
                 # render_script should always be inferable using __file__
        ...
        self.render_script = os.path.join(self.package_directory, 'render_samples.py')
